# Accessible Reading v2.0 - Plataforma de Estudio Bíblico Accesible
...
**Accessible Reading** es una plataforma web progresiva (PWA) de estudio bíblico diseñada desde cero con un enfoque neurocognitivo para la accesibilidad (especialmente dislexia). No es solo un lector; es una implementación de referencia de principios de diseño inclusivo basados en evidencia científica.
